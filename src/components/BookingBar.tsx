    ...
    >
      <div className="flex flex-col gap-0.5">
        ...
        <div className="flex items-baseline gap-0.5">
          <span className="text-white text-[26px] sm:text-[32px] font-medium tracking-[-0.05em] leading-none">
            ₹500
          </span>
          <span className="text-[rgba(255,255,255,0.5)] text-[15px] font-medium tracking-[-0.02em]">
            /hr
          </span>
        </div>
      </div>
      ...
      <button
        type="button"
        onClick={onBookClick}
        className="bg-white text-black text-[16px] sm:text-[18px] font-medium tracking-[-0.03em] px-6 py-3 sm:px-8 sm:py-3 rounded-full transition-colors duration-100 hover:bg-[#e8e8e8] active:scale-[0.96]"
      >
        Book Now
      </button>
    </div>
